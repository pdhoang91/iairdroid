...
function callAction() {
  if (
    ...
    document
      ...
      .src.startsWith("https://ton-claim.tokentable.xyz/project/")
  )
    return;

  if (document.querySelector("iframe").src.startsWith("https://onetime.dog")) {
    console.log("Đang bật token table cho dogs");
    document.querySelector("iframe").src = document
      .querySelector("iframe")
      .src.replace(
        "https://onetime.dog/",
        "https://ton-claim.tokentable.xyz/project/dogs"
      );
  }
}
